...
- **FEEDBACK/SUGGESTIONS:** A noticeable delay during generation process but it's bearable. I suggest having a fallback, like a loading screen or something to hint users that they're anticipating for an event to happen. Also, on the creation, I suggest putting a popup toast to inform user of the successsful creation.
...
## CODE: AI003 - NOT YET IMPLEMENTED
...
- **STATUS:** PASSED
- **ERROR ENCOUNTERED:** N/A
- **FEEDBACK/SUGGESTIONS:** Generating flashcards from notes and saving the generated flashcard both work properly. Fast delay.
...
- **STATUS:** PASSED
- **ERROR ENCOUNTERED:** N/A
- **FEEDBACK/SUGGESTIONS:** Generation and saving works properly. Noticeable delay during generation process but is bearable.
...
- **STATUS:** PASSED
- **ERROR ENCOUNTERED:** N/A
- **FEEDBACK/SUGGESTIONS:** Generation and saving works properly with no errors. Probably second to fastest delay among other ai generation processes.
...
- **STATUS:** PASS
- **ERROR ENCOUNTERED:** N/A
- **FEEDBACK/SUGGESTIONS:** Quiz generation and saving works properly with no errors. Still a noticeable delay in generation but bearable.
